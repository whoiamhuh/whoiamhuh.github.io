                        ...
                        <div class="w-full">
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.two') }}">
                                ...
                                <div class="sm:col-span-6 pt-5">
                                    <label for="status" class="block text-sm font-medium text-gray-700">Стол</label>
                                    <div class="mt-1">
                                ...
                                <div class="mt-6 p-4 flex justify-between">
                                    ...
                                    <button type="submit"
                                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Забронировать стол</button>
                                </div>
                            </form>
                        </div>
                    </div>
